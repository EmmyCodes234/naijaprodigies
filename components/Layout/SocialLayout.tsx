...
const SocialLayout: React.FC<SocialLayoutProps> = ({ children, showWidgets = true, fullWidth = false, hideBottomNav: propHideBottomNav }) => {
    ...
    const NavItems = [
        ...
        // DISABLED: { icon: 'ph:television-simple', activeIcon: 'ph:television-simple-fill', label: 'TV', path: '/tv' },
        // DISABLED: { icon: 'ph:trophy', activeIcon: 'ph:trophy-fill', label: 'Director', path: '/director' },
        // DISABLED: { icon: 'ph:flag-checkered', activeIcon: 'ph:flag-checkered-fill', label: 'Tournaments', path: '/tournaments' },
