...
const GistRoom: React.FC = () => {
    ...
    return (
        <>
            {/* Desktop Overlay */}
            <div className="hidden md:block fixed inset-0 z-[59] bg-black/60 backdrop-blur-sm animate-in fade-in duration-300" onClick={toggleMinimize} />

            <div className="fixed inset-0 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[95vw] md:max-w-6xl md:h-[85vh] z-[60] flex flex-col bg-[#052120] text-white animate-in slide-in-from-bottom-10 md:zoom-in-95 duration-500 overflow-hidden font-sans pb-safe h-[100dvh] md:rounded-[2.5rem] md:border md:border-white/10 md:shadow-2xl">
                {/* Reactions Layer */}
                <GistReactions />
                ...
                <div className="relative z-10 p-6 pt-0 pb-safe-offset-4 md:pb-8">
                    <div className="max-w-2xl mx-auto flex items-center justify-between gap-4 md:gap-6 px-4 py-3 md:py-4 bg-[#0f3c3a]/40 backdrop-blur-3xl rounded-[2.5rem] shadow-2xl border border-white/5 w-full">
                        {/* Left Actions */}
